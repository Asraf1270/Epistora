<?php
$page_title = "Privacy Policy - Epistora";
include 'header.php';
?>
...
<main class="max-w-4xl mx-auto px-5 sm:px-8 py-12 lg:py-16 prose dark:prose-invert">
  ...
  <p>Epistora respects your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service.</p>

  <h2>1. Information We Collect</h2>
  <ul>
    <li><strong>Personal Information</strong>: Email, username, display name (provided during registration)</li>
    <li><strong>Usage Data</strong>: IP address, browser type, pages visited, time spent</li>
    <li><strong>Cookies & Similar Technologies</strong>: See our <a href="cookie.php">Cookie Policy</a></li>
  </ul>

  <h2>2. How We Use Your Information</h2>
  <ul>
    <li>To provide, maintain, and improve the Service</li>
    <li>To communicate with you (account notifications, updates)</li>
  ...
  <ul>
    ...
    <li>If required by law or to protect rights/safety</li>
  </ul>

  <h2>4. Data Security</h2>
  <p>We implement reasonable security measures, but no method is 100% secure.</p>

  <h2>5. Your Rights</h2>
  <p>You may request access, correction, or deletion of your personal data by contacting us.</p>

  <h2>6. Children’s Privacy</h2>
  <p>Our Service is not directed at children under 13. We do not knowingly collect data from children under 13.</p>

  <h2>7. Changes to this Policy</h2>
  <p>We may update this Privacy Policy. Changes will be posted here with updated date.</p>
