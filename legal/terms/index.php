<?php
// terms.php
$page_title = "Terms of Service - Epistora";
...
<main class="max-w-4xl mx-auto px-5 sm:px-8 py-12 lg:py-16 prose dark:prose-invert">
  ...
  <p>Welcome to Epistora ("we", "our", "us"). These Terms of Service ("Terms") govern your access to and use of Epistora (the "Service"), including our website and any related services.</p>
  ...
  <h2>2. Eligibility</h2>
  <p>You must be at least 13 years old to use Epistora. If you are under 18, you must have parental permission.</p>
  ...
  <p>You retain ownership of content you post, but grant Epistora a worldwide, non-exclusive, royalty-free license to host, display, and distribute it on the platform.</p>
  ...
  <p>Epistora is provided "as is". We are not liable for any indirect, incidental, or consequential damages arising from your use of the Service.</p>
  ...
  <h2>Contact</h2>
  <p>If you have questions about these Terms, contact us at: <a href="mailto:contact@epistora.free.nf">contact@epistora.free.nf</a></p>
</main>
